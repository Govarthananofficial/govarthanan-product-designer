...
exports.handler = async function (event) {
  ...
  const { name, email, company, mobile, message, location, latitude, longitude, device, deviceName, browser } = payload;
  ...
  const safeDeviceName = sanitize(deviceName || "Unknown OS");
      ...
      <tr>
        <td style="padding: 4px;">
          <a href="https://www.linkedin.com/in/sgovarthanan/"
             style="display:inline-block;background:#1A1A18;text-decoration:none;border-radius:20px;padding:8px 14px;font-family:-apple-system,BlinkMacSystemFont,'Helvetica Neue',Helvetica,Arial,sans-serif;font-size:11px;font-weight:700;color:#FAFAF8 !important;text-transform:uppercase;letter-spacing:0.05em;" title="LinkedIn">
            LinkedIn
          </a>
        </td>
        <td style="padding: 4px;">
          <a href="https://www.behance.net/govarthananuxui"
             style="display:inline-block;background:#1A1A18;text-decoration:none;border-radius:20px;padding:8px 14px;font-family:-apple-system,BlinkMacSystemFont,'Helvetica Neue',Helvetica,Arial,sans-serif;font-size:11px;font-weight:700;color:#FAFAF8 !important;text-transform:uppercase;letter-spacing:0.05em;" title="Behance">
            Behance
          </a>
        </td>
        <td style="padding: 4px;">
          <a href="https://github.com/salkomdesignstudio"
             style="display:inline-block;background:#1A1A18;text-decoration:none;border-radius:20px;padding:8px 14px;font-family:-apple-system,BlinkMacSystemFont,'Helvetica Neue',Helvetica,Arial,sans-serif;font-size:11px;font-weight:700;color:#FAFAF8 !important;text-transform:uppercase;letter-spacing:0.05em;" title="GitHub">
            GitHub
          </a>
        </td>
        <td style="padding: 4px;">
          <a href="https://www.npmjs.com/package/@salkomdesignstudio/sds-motion-forge"
             style="display:inline-block;background:#1A1A18;text-decoration:none;border-radius:20px;padding:8px 14px;font-family:-apple-system,BlinkMacSystemFont,'Helvetica Neue',Helvetica,Arial,sans-serif;font-size:11px;font-weight:700;color:#FAFAF8 !important;text-transform:uppercase;letter-spacing:0.05em;" title="npm">
            npm
          </a>
        </td>
        <td style="padding: 4px;">
          <a href="https://www.figma.com/community/plugin/1638543298157640831/framestack-pdf"
             style="display:inline-block;background:#1A1A18;text-decoration:none;border-radius:20px;padding:8px 14px;font-family:-apple-system,BlinkMacSystemFont,'Helvetica Neue',Helvetica,Arial,sans-serif;font-size:11px;font-weight:700;color:#FAFAF8 !important;text-transform:uppercase;letter-spacing:0.05em;" title="Figma">
            Figma
          </a>
        </td>
      </tr>
            ...
            <td style="padding: 24px 40px; border-bottom: 1px solid #D8D8D4;">
              <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%">
                <tr>
                  ...
                  <td align="right">
                    <a href="https://govarthanan-ai-product-designer.netlify.app/"
              ...
              <table role="presentation" cellpadding="0" cellspacing="0" border="0"
                ...
                <tr>
                  ...
                  <td class="btn-half r" style="width:50%;padding-left:6px;" valign="top">
                    <a href="https://govarthanan-ai-product-designer.netlify.app/sds-motion-forge.html"
                       style="display:block;text-align:center;text-decoration:none;
                              font-family:-apple-system,BlinkMacSystemFont,'Helvetica Neue',Helvetica,Arial,sans-serif;
                              font-size:12px;font-weight:700;letter-spacing:0.1em;text-transform:uppercase;
              ...
              <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%">
                <tr>
                  <td class="cta-half" style="width:50%;padding-right:6px;" valign="top">
                    <a href="mailto:${safeEmail}?subject=Re%3A%20Your%20message%20on%20govarthanan-ai-product-designer.netlify.app&body=Hi%20${encodeURIComponent(name)}%2C%0A%0A"
                       style="display:block;text-align:center;text-decoration:none;
                              font-family:-apple-system,BlinkMacSystemFont,'Helvetica Neue',Helvetica,Arial,sans-serif;
                              font-size:12px;font-weight:700;letter-spacing:0.1em;text-transform:uppercase;
          ...
          <tr>
            <td style="padding:14px 32px 20px;border-top:1px solid #2A2A26;text-align:center;">
              <p style="font-family:-apple-system,BlinkMacSystemFont,'Helvetica Neue',Helvetica,Arial,sans-serif;
                ...
                &nbsp;&middot;&nbsp;
                govarthanan-ai-product-designer.netlify.app
              </p>
            </td>
          </tr>
